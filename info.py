...
API_ID = int(environ.get('API_ID', '29675385'))
API_HASH = environ.get('API_HASH', 'd727696cb734c419da0bc4565465973c')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '650908295').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002850059139'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002723844170').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002737099888') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '650908295')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002888855471').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ghostrider6368:hjFxKtBYhGKFHmec@cluster0.c1qvzd1.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+IBe0FWCQXQw1Y2E1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+ZoExJgW2r9djYmE1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+hILsnP_vvNE4ZTRl') # Support Chat Link Without https:// or @
